/* Weather API */
const apiURL = "https://api.openweathermap.org/data/2.5/weather?id=5678757&appid=cbf6f180a0de7965e7eda02d85df55c9";
fetch(apiURL)
  ...
  const forecasturl = "https://api.openweathermap.org/data/2.5/forecast?id=5678757&appid=cbf6f180a0de7965e7eda02d85df55c9";
  fetch(forecasturl)
  .then((response) => response.json())
  .then((jsObject) => {
    console.log(jsObject);
